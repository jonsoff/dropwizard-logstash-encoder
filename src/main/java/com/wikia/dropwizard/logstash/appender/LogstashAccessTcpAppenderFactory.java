...
@JsonTypeName("logstash-access-tcp")
public class LogstashAccessTcpAppenderFactory extends AbstractLogstashAppenderFactory {
  ...
  public LogstashAccessTcpAppenderFactory() {
